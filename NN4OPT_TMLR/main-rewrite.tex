...
Mean $v_r(\bm{\theta})$ & Std $v_r(\bm{\theta})$ & Relax.\ Gap$^\ast$ & MAE & $q_{99}$ \\
\midrule
...
\midrule
  \multirow{2}{*}{Robust Knapsack} & Exact (Integer) & \texttt{n=25} & 281 & 46.9 & 0 & 1.23 & 3.96 \\
   & SOCP & \texttt{n=25} & 281 & 46.9 & 1.71 & 1.16 & 3.66 \\
\bottomrule
\end{tabular}
\end{table}
...
\cmidrule(lr){4-9}
\textbf{Experiment} & \textbf{Relaxation} & \textbf{Case} &
Mean / Worst Opt.\ Gap$^\ast$ & $\delta$ & TP & FP & TN & FN \\
\midrule
  \multirow{1}{*}{QCQP} & Shor &  & 9.76 / 71.1 & 0.139 & 2524 & 0 & 2474 & 2 \\
\midrule
  \multirow{2}{*}{Inverse Kinematics} & Shor &  & 0.011 / 2 & 0.00282 & 4533 & 0 & 193 & 267 \\
   & Lasserre-2 &  & 0.011 / 2 & 0.00282 & 4799 & 0 & 193 & 1 \\
\midrule
  \multirow{1}{*}{MIMO Detection} & Shor &  & 0.0019 / 2.64 & 0.0122 & 96 & 0 & 4 & 4900 \\
\midrule
  \multirow{15}{*}{AC-OPF} & SOCP & \texttt{case9} & 4e-05 / 0.0014 & 43.6 & 5000 & 0 & 0 & 0 \\
   & SOCP & \texttt{case14} & 0.0057 / 5.15 & 57.2 & 4999 & 0 & 0 & 1 \\
   & SOCP & \texttt{case39} & 4.11 / 351 & 376 & 4542 & 0 & 0 & 109 \\
   & SOCP & \texttt{case89pegase} & 0.026 / 0.33 & 42.4 & 4698 & 0 & 0 & 75 \\
   & SOCP & \texttt{case118} & 2.01 / 4.82 & 861 & 4952 & 0 & 0 & 48 \\
   & SOCP & \texttt{case300} & 235 / 9,692 & 3,925 & 3702 & 0 & 9 & 232 \\
   & SOCP & \texttt{case1354pegase} & 5.96 / 32.9 & 398 & 3844 & 0 & 0 & 0 \\
   & SOCP & \texttt{case2869pegase} & 260 / 6,538 & 731 & 2957 & 0 & 259 & 0 \\
   & SDP & \texttt{case9} & 4e-05 / 0.0014 & 43.6 & 5000 & 0 & 0 & 0 \\
   & SDP & \texttt{case14} & 0.0057 / 5.15 & 57.2 & 5000 & 0 & 0 & 0 \\
   & SDP & \texttt{case39} & 4.11 / 351 & 376 & 4584 & 0 & 0 & 67 \\
   & SDP & \texttt{case89pegase} & 0.026 / 0.33 & 42.4 & 4750 & 0 & 0 & 28 \\
   & SDP & \texttt{case118} & 2.01 / 4.82 & 861 & 4995 & 0 & 0 & 5 \\
   & SDP & \texttt{case300} & 235 / 9,692 & 3,925 & 3894 & 0 & 9 & 39 \\
   & SDP & \texttt{case1354pegase} & 5.96 / 32.9 & 398 & 3855 & 0 & 0 & 0 \\
\midrule
  \multirow{2}{*}{Robust Knapsack} & Exact (Integer) & \texttt{n=25} & 9.02 / 24.5 & 1.41 & 50 & 4 & 4238 & 708 \\
   & SOCP & \texttt{n=25} & 9.02 / 24.5 & 1.41 & 7 & 1 & 4241 & 751 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
  \multirow{2}{*}{Robust Knapsack} & Exact (Integer) & \texttt{n=25} & -- & 0.0687 ms \\
