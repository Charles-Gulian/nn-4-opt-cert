...
\midrule
  \multirow{2}{*}{Robust Knapsack} & Exact (Integer) & \texttt{n=20000} & 281 & 46.9 & 0 & 1.23 & 3.96 \\
   & Continuous (Linear) & \texttt{n=20000} & 281 & 46.9 & 1.71 & 1.16 & 3.66 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
  \multirow{2}{*}{Robust Knapsack} & Exact (Integer) & \texttt{n=20000} & 9.02 & 24.5 & 50 & 4 & 4238 & 708 \\
   & Continuous (Linear) & \texttt{n=20000} & 9.02 & 24.5 & 7 & 1 & 4241 & 751 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
  \multirow{2}{*}{Robust Knapsack} & Exact (Integer) & \texttt{n=20000} & -- & 0.0687 ms \\
   & Continuous (Linear) & \texttt{n=20000} & -- & 0.0687 ms \\
\bottomrule
\end{tabular}
\end{table}
